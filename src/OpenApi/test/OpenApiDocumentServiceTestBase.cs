...
public abstract class OpenApiDocumentServiceTestBase
{
    ...
    {
        // Arrange
        var apiDescriptionGroupCollectionProvider = GetApiDescriptionGroupCollectionProvider(new List<ApiDescription>
        {
            GetApiDescription(handler, route, httpMethods: httpMethods),
        });
